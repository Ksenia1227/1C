<template>
  <div v-if="generated" class="page">
    <h1 class="title">Данные организации</h1>
    ...
    <details class="section">
      ...
      <div class="card">
        ...
        <p>
          <strong>Полное наименование:</strong> {{ generated.organization[2] }}
        </p>
        ...
        <p>
          ...
          {{ formatDate(generated.organization[6]) }}
        </p>
        <p>
          <strong>Регистрирующий орган:</strong> {{ generated.organization[7] }}
        </p>
        <p>
          <strong>Юридический адрес:</strong> {{ generated.organization[8] }}
        </p>
        <p>
          <strong>Фактический адрес:</strong> {{ generated.organization[9] }}
        </p>
        <p><strong>Телефон:</strong> {{ generated.organization[10] }}</p>
        <p>
          <strong>Электронная почта:</strong> {{ generated.organization[11] }}
        </p>
      </div>
    </details>
    ...
    <details class="section">
      <summary>Сотрудники ({{ generated.employees.employees.length }})</summary>
